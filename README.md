...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/kanban_for_blitzjs
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/kanban_for_blitzjs_test
```
